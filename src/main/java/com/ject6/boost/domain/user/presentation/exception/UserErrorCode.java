...
public enum UserErrorCode implements ErrorCode {
    ...
    REGION_REQUIRED("USER-006", "지역을 하나 이상 선택해 주세요.", HttpStatus.BAD_REQUEST),
    CATEGORY_NOT_FOUND("USER-007", "존재하지 않는 카테고리입니다.", HttpStatus.BAD_REQUEST),
    REGION_NOT_FOUND("USER-008", "존재하지 않는 지역입니다.", HttpStatus.BAD_REQUEST),
    USER_NOT_FOUND("USER-009", "사용자를 찾을 수 없습니다.", HttpStatus.UNAUTHORIZED),
    ACTIVITY_CHANNEL_TYPE_REQUIRED("USER-010", "활동 채널 유형이 필요합니다.", HttpStatus.BAD_REQUEST),
    ACTIVITY_CHANNEL_URL_REQUIRED("USER-011", "활동 채널 URL이 필요합니다.", HttpStatus.BAD_REQUEST);
